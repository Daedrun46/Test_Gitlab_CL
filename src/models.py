...
class Recipe(Base):
    """
       ...
       - views: Счётчик просмотров рецепта, используется для сортировки по популярности.
       """
    __tablename__ = "recipes"

    id = Column(Integer, primary_key=True, index=True, doc="Уникальный идентификатор рецепта")
    ...
    description = Column(Text, nullable=False, doc="Подробная инструкция по приготовлению")
